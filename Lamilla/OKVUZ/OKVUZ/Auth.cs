...
namespace OKVUZ
{
    public partial class Auth : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("Select Count (*) From dbo.Управляющие_Приложением where Логин = '" + Login.Text + "' and Пароль = '" + textBox1.Text + "'", sqlConnection);
